...
public class ValueConverter {
    public static final double MASS = 66.336E-27;
    ...
    public static final double DENSITY = 1 / (GAMMA * GAMMA * GAMMA);
    ...
    public static String getEnergy(double energy) {
        return "Потенциальная энергия: " + energy * GAMMA + " Дж";
    }

    public static String getDensity(double density) {
        return "Плотность: " + density * DENSITY + " ";
    }
}
